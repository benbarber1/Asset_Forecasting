...
# ─────────────────────────────────────────────
INPUT_FILE   = r"C:\Users\bbarber\OneDrive - BGB Group\Documents\1) Project work\BD\BD-014\Data analysis\2 June - VW\VW_input_file.xlsx"   # accepts .xlsx or .csv
OUTPUT_EXCEL = r"C:\Users\bbarber\OneDrive - BGB Group\Documents\1) Project work\BD\BD-014\Data analysis\2 June - VW\vw_output.xlsx"
OUTPUT_CHART = r"C:\Users\bbarber\OneDrive - BGB Group\Documents\1) Project work\BD\BD-014\Data analysis\2 June - VW\vw_chart.png"
...
#  STEP 6 — Excel output
# ─────────────────────────────────────────────
def export_excel(stacked: dict[str, np.ndarray], path: str):
    unique_sorted = {q: np.sort(np.unique(v)) for q, v in stacked.items()}
    max_len = max(len(v) for v in unique_sorted.values())

    out = {}
    for q in QUESTIONS:
        arr = unique_sorted[q].astype(float)
...
def main():
    ...
    # 6. Export Excel
    export_excel(stacked, OUTPUT_EXCEL)
